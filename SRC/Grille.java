...
public class Grille {
    ...
    public boolean estGagne() {
        ...
        if (this.lBombe.equals(this.lDrapeux)){
            return true;
        }
        else{
            return false;
    ...
    public void afficher() {
        ...
        for (int i = 0; this.nbLig > i; i++) {
            for (int j = 0; this.nbCol > j; j++) {
                this.getCase(i, j).afficher();
                // System.out.print(this.grille.get(i).get(j).toString());
            } 
            System.out.println();
        }
    ...
    public void creuser(int lig, int col) {
        ...
        if (this.getCase(lig, col).getEstRelevee()) {
            System.out.println("Vous avez déjà creuse cette case.");
        } 
